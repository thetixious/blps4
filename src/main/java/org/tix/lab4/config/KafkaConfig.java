...
public class KafkaConfig {
    ...
    public ProducerFactory<String, ExpertMessage> producerFactory() {
        ...
        properties.put(JsonSerializer.TYPE_MAPPINGS, "token: org.tix.lab4.model.ExpertMessage");
    ...
    public ConsumerFactory<String, ExpertMessage> consumerFactory() {
        ...
        props.put(JsonDeserializer.TYPE_MAPPINGS, "token:org.tix.lab4.model.ExpertMessage");
